...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var packId, pack, updatedPack, orphanedSamples, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, prisma.samplePack.update({
                            where: { id: parseInt(packId) },
                            data: {
